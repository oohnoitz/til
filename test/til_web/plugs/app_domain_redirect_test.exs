defmodule TilWeb.AppDomainRedirectTest do
  @moduledoc """
  Tests for TilWeb.AppDomainRedirect
  """
  use TilWeb.ConnCase, async: true
  alias TilWeb.AppDomainRedirect
  ...
  test "redirects from bad hostname when active" do
    port = get_in(Application.get_env(:til, TilWeb.Endpoint), [:http, :port])
